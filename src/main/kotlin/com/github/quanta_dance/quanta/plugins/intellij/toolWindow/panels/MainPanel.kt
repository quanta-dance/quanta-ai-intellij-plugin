...
class MainPanel(var project: Project) : JPanel(BorderLayout()) {
    ...
    val messageScrollPane = JBScrollPane(messagePanel).apply {
    ...
    private val submitButton = JButton(AllIcons.Actions.RunAll).apply {
        isFocusable = false
        addActionListener { e ->
    ...
    private val promptButtonPanel = JPanel().apply {
    ...
    private val promptPanel = JPanel().apply {
        layout = BorderLayout()
    ...
    private fun newPromptTextArea() = JTextArea().apply {
        lineWrap = true
        wrapStyleWord = true
        rows = 4
