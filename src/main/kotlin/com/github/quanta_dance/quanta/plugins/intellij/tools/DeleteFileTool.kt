...
@JsonClassDescription("Tool to delete a specified file from the project. Before modifying methods in the file you may need to check for this method references as they might need to be updated.")
class DeleteFileTool : ToolInterface<String> {
    ...
    override fun execute(project: Project): String {
        ...
        val target = try {
            ...
            project.service<ToolWindowService>().addToolingMessage("File delete - rejected", e.message ?: "Invalid path")
