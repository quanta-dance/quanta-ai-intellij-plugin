...
class BackendSettingsRpcApiTest {
    ...
    @Test
    fun `updateSettings writes effective settings into backend runtime service`() = runBlocking {
    ...
    @Test
    fun `getSettings returns snapshot from backend runtime service`() = runBlocking {
        val api = BackendSettingsRpcApi()
