...
package com.github.quanta_dance.quanta.plugins.intellij.frontend.toolwindow.cards
...
class SuggestionCardPanel(
    ...
    private fun attachDocumentListener(project: Project) {
       // val basePath = PathUtils.projectRootPath(project) ?: return
        val basePath = project.basePath ?: return // TODO: fix it as this must align with backend - not frontend
        val vFile =
    ...
    private fun scrollToOffsetAndSelect(
     ...
     //   val basePath = PathUtils.projectRootPath(project) ?: return
        ...
        virtualFile?.let {
            val followEnabled = FrontendQuantaSettingsState.instance.state.followEnabled
    ...
    private fun plannedOffsets(project: Project): Pair<Int, Int>? {
       // val basePath = PathUtils.projectRootPath(project) ?: return null
        val basePath = project.basePath  // TODO: fix it as this must align with backend - not frontend
    ...
    //    val path = (PathUtils.projectRootPath(project) ?: return) + "/" + suggestion.file
        var path = project.basePath ?: return // TODO: fix it as this must align with backend - not frontend
